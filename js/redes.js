...
const sr = ScrollReveal({ origin: "top", distance: window.innerWidth <= 768 ? '15px' : '40px', duration: 2500, delay: 400 });

sr.reveal(".contact__content"),
     sr.reveal("#card-sobre-container,#social-container, #cabo-card, #ronin-txt, #externo, #ap, #mesh", { delay: 600, origin: "bottom", interval: 100 }),
     sr.reveal("#main-text, #ronin-img, #footer-logo img, #footer-content", { origin: "left" }),
